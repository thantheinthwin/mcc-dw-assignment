                ...
                <div class="row mt-5 justify-content-center">
                    <div class="col-8 col-lg-12">
                        <div class="col-lg-8 border-bottom p-3">
                            ...
                            <span class="lead fs-4">Zone A | Lake</span>
                            <p class="my-2 fs-5">Relieve your stress. Have some fun.</p>
                        </div>
                            ...
                            <div class="row">
                                <div class="col mt-4">
                                    <ol class="lead fs-5">
                                        ...
                                        <li>Emptiying chemical toilets is allowed only on a designated place.</li>
                                        <li>Guests should keep their pitch area clear and tidy.</li>
                                        <li>Ouiet hours are from 14:00 till 16:00 and from 22:00 till 7:00.</li>
                                        <li>Use of electric stoves, and heating is not allowed and can result in power shut down.</li>
                                        <li>Smoking inside caravan/rented tents/cabins is strictly forbiddden.</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
